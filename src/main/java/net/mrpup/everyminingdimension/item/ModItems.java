...
public class ModItems {
    ...
    public static final DeferredHolder<Item, BlockItem> TELEPORT_OVERWORLD_MINING_DIMENSION = ITEMS.register(
            "teleport_overworld_mining_dimension", id -> new BlockItem(ModBlocks.TELEPORT_OVERWORLD_MINING_DIMENSION.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id)))
    );

    public static final DeferredHolder<Item, BlockItem> TELEPORT_NETHER_MINING_DIMENSION = ITEMS.register(
            "teleport_nether_mining_dimension", id -> new BlockItem(ModBlocks.TELEPORT_NETHER_MINING_DIMENSION.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id)))
    );

    public static final DeferredHolder<Item, BlockItem> TELEPORT_END_MINING_DIMENSION = ITEMS.register(
            "teleport_end_mining_dimension", id -> new BlockItem(ModBlocks.TELEPORT_END_MINING_DIMENSION.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id)))
    );
