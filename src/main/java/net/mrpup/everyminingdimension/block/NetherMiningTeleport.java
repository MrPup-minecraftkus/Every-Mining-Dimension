...
public class NetherMiningTeleport extends Block {
    ...
    public NetherMiningTeleport(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult) {
        ...
        ResourceKey<Level> miningKey = ResourceKey.create(Registries.DIMENSION, Identifier.fromNamespaceAndPath("everyminingdimension", "nether_mining_dimension"));
    ...
    private InteractionResult teleportPlayer(Player player, ServerLevel currentWorld, ResourceKey<Level> targetKey, BlockPos overworldPortalPos) {
        ...
        BlockPos portalPos;
        if (targetKey.identifier().equals(Identifier.fromNamespaceAndPath("everyminingdimension", "nether_mining_dimension"))) {
