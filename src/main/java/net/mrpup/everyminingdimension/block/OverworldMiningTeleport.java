...
public class OverworldMiningTeleport extends Block {
    ...
    public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult) {
        ...
        ResourceKey<Level> miningKey = ResourceKey.create(Registries.DIMENSION, ResourceLocation.fromNamespaceAndPath(EveryMiningDimension.MOD_ID, "overworld_mining_dimension"));
    ...
    private InteractionResult teleportPlayer(Player player, ServerLevel currentWorld, ResourceKey<Level> targetKey, BlockPos overworldPortalPos) {
        ...
        BlockPos portalPos;
        if (targetKey.location().equals(ResourceLocation.fromNamespaceAndPath(EveryMiningDimension.MOD_ID, "overworld_mining_dimension"))) {
